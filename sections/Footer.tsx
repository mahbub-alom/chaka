        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center animate-fade-in">
              <div className="relative flex items-center h-10 text-primary dark:text-orange-400">
                <svg
              ...
              <a
                ...
                className={`w-8 h-8 rounded-full flex items-center justify-center border transition-all duration-300 hover:-translate-y-0.5 ${
                  isDarkMode
                    ...
                    : "border-slate-200 bg-slate-50 hover:border-orange-600 hover:text-primary shadow-xs"
                }`}
            ...
            <ul className="space-y-2.5 text-xs text-slate-600 dark:text-slate-400">
              <li>
                <button
                  ...
                  className="hover:text-primary dark:hover:text-orange-500 transition-colors flex items-center gap-1.5 text-left font-medium cursor-pointer bg-transparent border-0 p-0"
                >
              ...
              <li>
                ...
                >
                  ...
                  {language === "bn" ? "নিরাপত্তা গাইড" : "Safety Guide"}
                </button>
              </li>
              <li>
                <button
                  ...
                  className="hover:text-orange-500 text-primary font-black transition-all text-left flex items-center gap-1.5 cursor-pointer uppercase tracking-tight text-[11px] bg-transparent border-0 p-0"
                >
                  🇯🇵{" "}
                  {language === "bn"
                    ? "জাপানিজ অকশন শিট ভেরিফাই"
                    : "Verify Japanese Auction Sheet"}
                </button>
              </li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="space-y-2.5 text-xs text-slate-500 dark:text-slate-450">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold">01319075810</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-3">
              ...
              <a
                ...
                className={`flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all border duration-250 ${
                  isDarkMode
                    ...
                    : "bg-slate-50 border-slate-200 hover:border-primary text-slate-800 hover:shadow-lg"
                }`}
              >
                <svg
                ...
                >
                  <path
                    d="M3 20.25a2.22 2.22 0 0 0 .15.8c.17.43.51.77.93.94a2.22 2.22 0 0 0 .8.15h14.24a2.22 2.22 0 0 0 .8-.15c.42-.17.76-.51.93-.94a2.22 2.22 0 0 0 .15-.8V3.75a2.22 2.22 0 0 0-.15-.8 2.37 2.37 0 0 0-.93-.94A2.22 2.22 0 0 0 19.12 1.86H4.88a2.22 2.22 0 0 0-.8.15c-.42.17-.76.51-.93.94a2.21 2.21 0 0 0-.15.8 Z"
                    fill="#1E293B"
                    className="dark:fill-slate-800"
                  />
                  <path
                    d="m5.25 3.86 6.84 6.84-6.84 6.84v-13.68z"
                    fill="#0A5A53"
                  />
                  <path
                    d="m15.63 12-3.54-3.3-6.84-6.84h8.31a3 3 0 0 1 3 3v4.14L15.63 12z"
                    fill="#0EA5E9"
                  />
                  <path
                    d="m11.19 12-5.94 5.94v.1a3 3 0 0 0 3 3h8.31a3 3 0 0 0 3-3V14.1L15.63 12H11.19z"
                    fill="#10B981"
                  />
                  <path
                    d="M15.63 12h5.61c.42-.17.76-.51.93-.94.12-.3.15-.65.15-1.02V9.94a3 3 0 0 0-3-3l-2.73 2.52L15.63 12z"
                    fill="#F59E0B"
                  />
                </svg>
                <div className="text-left leading-tight">
                  ...
                  <span className="text-xs font-black tracking-tight">
                    {language === "bn" ? "গুগল প্লে স্টোর" : "Google Play"}
                  </span>
                </div>
              </a>
              ...
              >
                ...
                <div className="text-left leading-tight">
                  ...
                  <span className="text-xs font-black tracking-tight">
                    {language === "bn" ? "অ্যাপ স্টোর" : "App Store"}
                  </span>
                </div>
              </a>
            </div>
          ...
          <div className="flex items-center gap-3 text-[11px]">
            <button
              ...
              className={`flex items-center gap-1.5 py-1 px-2.5 rounded-md text-[11px] font-extrabold tracking-wide transition-all duration-200 cursor-pointer ${
                isDarkMode
                  ? "bg-slate-900 border border-slate-800 text-slate-300 hover:bg-primary/20 hover:text-orange-400"
                  : "bg-slate-50 border border-slate-100 text-slate-600 hover:bg-primary/10 hover:text-primary"
              }`}
            >
              <MessageSquare className="w-3.5 h-3.5" />{" "}
              {language === "bn" ? "মতামত জানান" : "Give Feedback"}
            </button>
            <span className="flex items-center gap-1 py-1 px-2.5 rounded-md bg-orange-500/10 text-primary font-black tracking-wide">
              {language === "bn"
                ? "🔒 এসএসএল সুরক্ষিত পেমেন্ট ভেরিফাইড"
                : "🔒 SSL Secured Payment Verified"}
            </span>
          </div>
        </div>
      </Container>
