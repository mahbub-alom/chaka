    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="space-y-6 mt-12 relative">
        ...
        <motion.div
          ...
          className="hidden sm:grid sm:grid-cols-4 xl:grid-cols-8 gap-5 pt-2"
        >
          {CATEGORIES_LIST.map((cat) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-2xl border cursor-pointer transition-all duration-500 p-4 flex flex-col justify-between h-[180px] z-10 ${isDarkMode
              ...
              >
                ...
                <div className="flex flex-col justify-between h-full w-full relative">
                  ...
                  <div className="text-center w-full">
                    ...
                    <span className="text-[9.5px] text-slate-404 dark:text-slate-500 font-medium block mt-0.5 line-clamp-1 group-hover:text-slate-500 dark:group-hover:text-slate-400 transition-colors duration-300">
                      {subtitleText}
                    </span>
                  </div>
                </div>
        ...
        <motion.div
          ...
          whileInView="show"
          viewport={{ once: true, margin: "-10px" }}
          className="sm:hidden block divide-y divide-slate-100/50 dark:divide-slate-900/40 mt-4 px-1"
        >
              ...
              >
                ...
                <div className="w-10 h-10 flex items-center justify-center shrink-0">
                  <ChevronRight className={`w-5 h-5 text-slate-400 dark:text-slate-655 transition-all duration-300 ${isEven
                      ...
                      : "group-hover/item:text-primary group-hover/item:-translate-x-1 rotate-180"
                    }`} />
                </div>
                ...
                <div className="flex-1 flex flex-col justify-center min-w-0 z-10">
                  ...
                  <span className="text-[10px] text-slate-404 dark:text-slate-500 font-semibold mt-0.5 tracking-wider truncate w-full uppercase block">
                    {subtitleText}
                  </span>
                  <span className="text-[8.5px] text-slate-450/80 dark:text-slate-555/80 font-mono font-medium block mt-1">
                    {countText}
                  </span>
                </div>
          ...
          <div className="flex items-center gap-2">
            <div className="flex items-center bg-slate-100 dark:bg-slate-900/40 p-0.5 rounded-lg border border-slate-300/30 dark:border-slate-800">
              <button
                ...
                className={`p-1 sm:p-1.5 rounded-md transition-all cursor-pointer ${homeViewMode === "grid"
              ...
              <button
                ...
                className={`p-1 sm:p-1.5 rounded-md transition-all cursor-pointer ${homeViewMode === "list"
                    ? "bg-primary text-white shadow-xs"
                    : "text-slate-500 dark:text-slate-404 hover:text-primary"
                  }`}
                title="Detailed list"
      ...
      <div
        className={`p-6 sm:p-8 rounded-3xl border transition-all duration-300 ${isDarkMode
      ...
      >
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div>
            <h3
              className={`text-base sm:text-lg font-black tracking-tight flex items-center gap-2 mb-1 ${isDarkMode ? "text-white" : "text-slate-900"
                }`}
            >
          ...
          <div
            className={`self-start sm:self-auto px-3 py-1.5 rounded-full border text-[10px] font-black tracking-wider flex items-center gap-1.5 shrink-0 ${isDarkMode
          ...
          {BANGLADESH_DIVISIONS.map((div) => {
            ...
            return (
              <div
                ...
                className={`relative p-4 rounded-2xl border cursor-pointer overflow-hidden transition-all duration-300 md:hover:-translate-y-1 hover:shadow-md flex flex-col justify-between group h-36 ${isDarkMode
              ...
              >
                ...
                <div className="flex items-start justify-between gap-2 relative z-10">
                  <div
                    className={`p-2 rounded-xl border flex items-center justify-center transition-colors ${isDarkMode
                  ...
                  <span
                    className={`text-[8px] font-black tracking-widest px-1.5 py-0.5 rounded ${isDarkMode
                ...
                <div className="relative z-10 mt-3">
                  <h4
                    className={`text-xs font-black tracking-tight transition-colors truncate ${isDarkMode
      ...
      <div className="space-y-6 py-4">
        ...
        <div
          className={`relative overflow-hidden w-full rounded-2xl border ${isDarkMode
        ...
        >
          ...
          <div
            className={`absolute inset-y-0 left-0 w-16 pointer-events-none z-10 bg-gradient-to-r ${isDarkMode
                ? "from-slate-950/80 to-transparent"
                : "from-[#faf8f5]/80 to-transparent"
              }`}
          />
          <div
            className={`absolute inset-y-0 right-0 w-16 pointer-events-none z-10 bg-gradient-to-l ${isDarkMode
                ? "from-slate-950/80 to-transparent"
                : "from-[#faf8f5]/80 to-transparent"
              }`}
          />
          ...
          <div className="flex gap-6 px-8 animate-marquee">
            {[...TOP_BRANDS_SCROLL, ...TOP_BRANDS_SCROLL].map((brand, idx) => (
              <button
                ...
                className={`group relative flex items-center justify-center w-28 h-28 sm:w-32 sm:h-32 rounded-2xl border transition-all duration-500 cursor-pointer p-4 shrink-0 hover:-translate-y-1.5 ${isDarkMode
